...
### Stolen vs. Lost Cards: The Crucial Distinction

Due to Swiss bureaucracy, there is a massive difference in how replacement cards are handled depending on whether they were "lost" or "stolen" while abroad.
...
Some airlines (particularly non-EU/Swiss carriers, e.g. Saudia) may refuse boarding to cardholders because their check-in staff do not recognize the Swiss/French legitimation card as a valid Schengen residence permit.

- **How to handle this**: Carry a physical printout or digital copy of the official host-state rules explaining Schengen card types to show the airline staff.
- **Resource**: Refer to the [CERN Users Office Help Crossing Borders](https://usersoffice.web.cern.ch/help-crossing-borders) guide for the official documents.
